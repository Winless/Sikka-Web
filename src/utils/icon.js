...
const loadingRedSvg = {
    ...
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" >
        <circle cx="12" cy="4" r="2" fill="#FF0080">
    
        </circle>
        <circle opacity="0.01" cx="17.6569" cy="6.34308" r="2" fill="#FF0080">
        </circle>
        <circle opacity="0.2" cx="20" cy="12" r="2" fill="#FF0080">
        </circle>
        <circle opacity="0.3" cx="17.6569" cy="17.6566" r="2" transform="rotate(45 17.6569 17.6566)" fill="#FF0080">
        </circle>
        <circle opacity="0.4" cx="12" cy="20" r="2" fill="#FF0080">
        </circle>
        <circle opacity="0.5" cx="6.34314" cy="17.6566" r="2" transform="rotate(45 6.34314 17.6566)" fill="#FF0080">
        </circle>
        <circle opacity="0.6" cx="4" cy="12" r="2" fill="#FF0080">
        </circle>
        <circle opacity="0.7" cx="6.34314" cy="6.34308" r="2" transform="rotate(45 6.34314 6.34308)" fill="#FF0080">
        </circle>
    </svg>
    `
}
const LoadingRed={
    template: `
    <a-icon :component="loadingRedSvg" />
  `,
    data() {
        return {
            loadingRedSvg,
...
const LoadingWhite={
    template: `
    <a-icon :component="loadingWhiteSvg" />
  `,
    data() {
        return {
            loadingWhiteSvg,
