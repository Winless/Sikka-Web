<template>
  <div>
    <div v-if="IsshowWithdraw">
      <a-modal v-model="visible" :footer="false" width="328px" wrapClassName="Withdraw" :afterClose="closemodel" :centered="true">
        ...
        <div class="Withdraw-input-title">
          ...
          <div>Withdraw Limit:<br>{{Withdraw.Withdrawable}}<span>{{ Withdraw.Withdrawablesymol }}</span></div>
        </div>
    ...
    <MobborrowCompleteF v-if="completemoadel" :settype="5" :completelist="this.completelist"></MobborrowCompleteF>
  </div>
</template>
