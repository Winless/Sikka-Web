...
<template>
  <div>
    <div v-if="isshowrepay">
      <a-modal v-model="visible" :footer="false" width="700px" wrapClassName="Repay" :afterClose="closemodel" :centered="true">
    ...
    <Complete v-if="completemoadel" :settype="1" :completelist="this.completelist"></Complete>
  </div>
</template>
