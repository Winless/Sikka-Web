<template>
  <div>
    <div v-if="showprovides">
      <a-modal v-model="visible" :footer="false" width="700px" wrapClassName="borrow" :afterClose="closemodel" :centered="true">
        ...
        <div class="progressf">
          <span class="amount-title">Deposit Amount</span>
          <span class="limit" @click="Ismax()">Max:<span>{{providesObj.limit}} aMATICb</span></span>
        </div>
    ...
    <loadingF v-if="loadingmoadel" :completelist="this.completelist"></loadingF>

    <Complete v-if="completemoadel" :settype="2" :completelist="this.completelist"></Complete>
  </div>
</template>
