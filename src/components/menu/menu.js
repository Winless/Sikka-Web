...
export default {
    ...
    methods: {
        ...
        updateMenu() {
            this.selectedKeys = [];
            let a = this.getSelectedKeys();
            a.forEach(item => {
                this.selectedKeys.push((item.split("/").length >= 3) ? "/" + item.split("/")[1] : item)
            })


            trace("updateMenu=", this.selectedKeys)
        ...
        getSelectedKeys() {
            ...
            trace("getSelectedKeys-chose=", chose, this.routesMap)
            ...
            trace("getSelectedKeys-matches=", matches)
